...
>git clone REPO_URL   # Initiate local git repository
>git log              # Shows previous commits and changes to the repo
...
>git add FILES              # Adds files to prepare for commit ('.' to add all in current directory)
>git commit -m MSG          # Commits files, '-m' to avoid terminal text editor
